...
// Level 20 the Properties of Arrows Challenge
// This challenge mirrors the Level 18 and 19 challenge, but requires that that Arrow Class is moved from GET/SET methods to properties
// Ensure the whole program can still run after the change
